...
repeat(ds_list_size(pergaminos)) {
    ds_list_add(nombres, global.idioma[? "desconocido"]);
}
...
global.scrollsNombres = ds_list_write_destroy(nombres);
